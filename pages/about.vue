...
<template>
  <div class="w-full min-h-screen flex flex-col items-center justify-center text-center py-16 md:py-24 lg:py-32 px-4 md:px-8 lg:px-0">
    <div ref="aboutContent">
      ...
      <div class="mb-6 flex flex-col items-center uppercase">
        <button 
          @click="toggleContentVisibility"
          class="group relative cursor-hover flex items-center gap-3 bg-background border-2 border-text px-8 py-4 rounded-full uppercase font-bold tracking-wider text-text hover:border-primary hover:bg-primary hover:text-background transition-all duration-300 overflow-hidden"
        >
        ...
        <p class="text-sm mt-3 opacity-70 transition-opacity duration-300 text-center">

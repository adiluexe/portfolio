  ...
  <div class="group cursor-hover w-full relative overflow-hidden">
    ...
    <div class="relative w-full aspect-[16/9] mb-4 overflow-hidden bg-background shadow-md border-1 rounded-md">
      ...
      <div class="absolute inset-0 bg-primary/90 opacity-0 group-hover:opacity-100 transition-all duration-300 flex flex-col items-center justify-center gap-4">
        ...
        <!-- Project Description -->
        <p class="text-center text-sm px-6 max-w-md text-background uppercase">
          {{ project.description }}
        </p>
        ...
        <div class="flex gap-3">
          ...
          <a 
            ...
            :href="project.github" 
            target="_blank"
            class="group/btn relative cursor-hover flex items-center justify-center w-12 h-12 bg-background border-2 border-background text-primary hover:border-background hover:bg-transparent hover:text-background transition-all duration-300 rounded-full"
            @click.stop
          ...
          >
            <svg v-if="project.website.startsWith('mailto:')" class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
